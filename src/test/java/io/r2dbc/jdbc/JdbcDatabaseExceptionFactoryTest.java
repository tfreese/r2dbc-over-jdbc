...
final class JdbcDatabaseExceptionFactoryTest {
    ...
    void testSqlDataException() {
        assertThat(JdbcR2dbcExceptionFactory.convert(new SQLDataException("SQLDataException", "SQLState", 999))).hasMessage("SQLDataException").isInstanceOf(R2dbcException.class)
                .extracting("sqlState", "errorCode").contains("SQLState", 999);
    }

    @Test
    void testSqlException() {
        assertThat(JdbcR2dbcExceptionFactory.convert(new SQLException("SQLException", "SQLState", 999))).hasMessage("SQLException").isInstanceOf(R2dbcException.class)
    ...
    void testTimeoutException() {
        assertThat(JdbcR2dbcExceptionFactory.convert(new SQLTimeoutException("SQLException", "SQLState", 999))).hasMessage("SQLException").isInstanceOf(R2dbcTimeoutException.class)
                .extracting("sqlState", "errorCode").containsExactly("SQLState", 999);
    }
