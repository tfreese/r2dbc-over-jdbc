...
abstract class AbstractTestKit implements TestKit<Integer> {
    ...
    public String doGetSql(final TestStatement statement) {
        return switch (statement) {
            ...
            case INSERT_VALUE_AUTOGENERATED_KEY -> "INSERT INTO test VALUES(100, 100)"; // Sollte komischerweise auch ohne den ID-Parameter gehen?!
    ...
    public ConnectionFactory getConnectionFactory() {
        if (connectionFactory == null) {
            connectionFactory = new JdbcConnectionFactory(getServer().getDataSource(), new DefaultCodecs());
        }
