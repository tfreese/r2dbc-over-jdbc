...
public class JanitorInvocationInterceptor implements InvocationInterceptor
{
    ...
    private void createTable(final JdbcOperations jdbcOperations)
    {
        ...
        try
        {
            jdbcOperations.execute("CREATE TABLE tbl (test_value INTEGER)");
        }
        catch (Exception ex)
        {
            // Ignore
        ...
        try
        {
            ...
            jdbcOperations
                    .execute("CREATE TABLE tbl_auto (id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY, test_value INTEGER)");
        }
        catch (Exception ex)
        {
            // Ignore
